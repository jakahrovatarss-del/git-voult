...
related-to:
  - "[[Homelab]]"
source: Reddit r/homelab objava
---
...
**Ideje:** Majhna poraba dobrebne, dober za lahki **Proxmox node** ali **Pi-hole/Home Assistant** strežnik. Lahko služi kot jump box za dostop do ostalih naprav.
...
> ramonvanraaij: Vsi bi ljeli Proxmox — naredi čuden, ampak funkcionalen Proxmox cluster. Tretji računalnik naj bo NAS.
