...
- [Fizika workflow](fizika-workflow.md) — korak 0, 7 virov, slog, samodejno shranjevanje
- [Fizika Obsidian struktura](fizika-obsidian-struktura.md) — mape, tipi not, frontmatter, pravila
